...
if ! dpkg -s ukylin-wechat &>/dev/null; then
    wget -O "$TEMP_DIR/ukylin-wechat.deb" https://archive.ubuntukylin.com/software/pool/partner/ukylin-wechat_3.0.0_amd64.deb
    sudo gdebi -n "$TEMP_DIR/ukylin-wechat.deb"
fi
